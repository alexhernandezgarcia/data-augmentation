#!/bin/bash
# Run from root folder with: bash scripts/blobs_run_oracle_augment.sh

export EXPERIMENT_FILE="blobs_experiment_oracle.yaml"
export PROJECT_NAME="blobs_experiment_oracle_augment"
