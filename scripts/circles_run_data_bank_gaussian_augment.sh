#!/bin/bash
# Run from root folder with: bash scripts/circles_run_data_bank_gaussian_augment.sh
export EXPERIMENT_FILE="circles_experiment_data_bank_sampling_gaussian_augment.yaml"
export PROJECT_NAME="circles_experiment_data_bank_sampling_gaussian_augment_2"
