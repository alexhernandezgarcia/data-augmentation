...
export EXPERIMENT_FILE="circles_experiment_uniform_sample_oracle_aug.yaml"
export PROJECT_NAME="circles_experiment_uniform_sample_oracle_aug_2"
...
datamodule.data_aug.n_augmentations=4,6,9,12,15,100 \
